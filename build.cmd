...
SET SUMMARY="Hystrix.NET.MetricsEventStream"
SET DESCRIPTION="Hystrix.NET.MetricsEventStream"

%FAKE% %NYX% "target=%TARGET%" appName=Hystrix.NET.MetricsEventStream appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Hystrix.NET.MetricsEventStream