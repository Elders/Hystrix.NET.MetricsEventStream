...
%FAKE% %NYX% appName=Elders.Hystrix.NET.MetricsEventStream appReleaseNotes=%RELEASE_NOTES% appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetkey=%RELEASE_NUGETKEY% nugetPackageName=Hystrix.NET.MetricsEventStream
